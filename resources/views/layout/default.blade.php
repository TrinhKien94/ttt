    ...
    <head>
        ...
        <script type="text/javascript">
             $(document).ready(function() {
                ...
                $(".order_books").click(function(event) {
                    event.preventDefault();
                    $.get("{{url('order')}}",$(this).closest("form").serialize(),function($respone) {
                        if($respone.error=="false"){
                            window.location.href="{{url('order')}}/"+$respone.order_id;
                        }else{
                            $("#error-order").empty();
                            $('#error-order').append($respone.money);
                            $('#error-order').append($respone.qtys);
                            $('#error-order').append($respone.deleted);
                        }
                    },'json');
                });
